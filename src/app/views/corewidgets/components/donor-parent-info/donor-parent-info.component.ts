      ...
      fieldGroup: [
        {
          ...
          templateOptions: {
            type: 'array',
            label: 'Archived?',
            description: 'Archived parent donors are hidden from view',
            options: [
              {label: 'Parent donor active and visible', value: false },
              {label: 'Archive and hide this parent donor', value: true },
            ],
            required: true,
          }
        }
